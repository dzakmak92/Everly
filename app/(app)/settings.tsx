      ...
      <View style={{ paddingHorizontal: 20, paddingTop: 8, gap: 12 }}>
        ...
        <View style={[{ backgroundColor: '#fff', borderRadius: radius.card, padding: 6 }, shadow.card]}>
          {[
            ...
            { label: 'Quick add', to: '/(app)/quick-add' },
            { label: 'Night log', to: '/(app)/nightlog' },
            { label: 'Rhythm ring', to: '/(app)/rhythm' },
            { label: 'Kiosk mode', to: '/(app)/kiosk' },
            { label: 'Weekly digest', to: '/(app)/digest' },
            { label: 'Family timezones', to: '/(app)/timezones' },
            { label: 'Gentle insights', to: '/(app)/insights' },
