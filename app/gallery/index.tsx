...
/**
 * Design gallery — the original static recreations, kept for reference. The
 * functional app lives under (app); this is reachable at /gallery.
 */
    ...
    <View style={{ flex: 1, backgroundColor: color.gallery }}>
      ...
      >
        ...
        <Text style={{ fontFamily: font.body400, fontSize: 14, color: '#8A6E8A', marginBottom: 28, lineHeight: 20 }}>
          Design gallery · {MODULES.length} modules · {totalScreens()} screens recreated from the design handoff.
        </Text>
